...
class UserManager(BaseUserManager):
    ...
    def create_inspector(self, email, password=None, **extra_fields):
        extra_fields.setdefault('is_staff', False)
        extra_fields.setdefault('is_superuser', False)
    ...
    def create_business_owner(self, email, password=None, **extra_fields):
        extra_fields.setdefault('is_staff', False)
        extra_fields.setdefault('is_superuser', False)
        extra_fields.setdefault('role', 'Business Owner')
        return self._create_user(email, password, **extra_fields)

    def create_health_regulator(self, email, password=None, **extra_fields):
        extra_fields.setdefault('is_staff', False)
        extra_fields.setdefault('is_superuser', False)
        extra_fields.setdefault('role', 'Health Regulator')
        return self._create_user(email, password, **extra_fields)
